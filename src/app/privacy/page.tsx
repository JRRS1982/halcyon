  ...
  return (
    ...
    >
      ...
      <p>
        ...
        except the hosting providers below.
      </p>

      <h2>Where it is stored</h2>
      <p>
        Your data is stored with Supabase (database and authentication) and the
        application runs on Vercel (hosting). These providers may process data
        outside the UK; where they do, transfers are protected by appropriate
        safeguards such as UK-approved standard contractual clauses under the
        providers&rsquo; data processing agreements.
      </p>
